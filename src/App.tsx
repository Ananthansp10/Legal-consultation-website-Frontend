    ...
    <Router>
      <div className="min-h-screen">
        <Routes>
          ...
          <Route
            path="/auth/lawyer/forgotpassword"
            element={<LawyerForgotPasswordPage />}
          />
          <Route
            path="/auth/lawyer/forgot-password-email-page"
            element={<LawyerForgotPasswordEmailPage />}
          />

          <Route path="/lawyer" element={<LawyerWelcomePage />} />
          <Route
            path="/lawyer-verification-status"
            element={<LawyerVerificationStatusPage />}
          />
          ...
          <Route element={<ProtectedRoute allowedRoles={["user"]} />}>
            ...
            <Route
              path="/user/lawyer-view-page/:lawyerId"
              element={<LawyerViewPage />}
            />
            <Route
              path="/user/slot-booking/:lawyerId"
            ...
            />
            <Route
              path="/user/chat-view-page/:lawyerId"
            ...
            />
            <Route
              path="/user/continue-slot-booking/:lawyerId/:caseId"
              element={<SlotBookingPage />}
            />
          </Route>
          ...
          <Route element={<ProtectedRoute allowedRoles={["lawyer"]} />}>
            ...
            <Route
              ...
              element={<LawyerResetPasswordPage />}
            />
            <Route
              path="/lawyer-profile-page"
              element={<LawyerProfilePage />}
            />
            <Route
              path="/lawyer/add-profile"
              element={<LawyerProfileAddPage />}
            />
            <Route
              path="/lawyer/add-availablity"
              element={<AvailablityAddPage />}
            />
            <Route path="/lawyer/appointments" element={<AppointmentPage />} />
            <Route path="/lawyer/slot-list-page" element={<SlotListPage />} />
            <Route
              path="/lawyer/subscription-plans"
              element={<SubscriptionPlanPage />}
            />
            <Route path="/lawyer/chat-list" element={<LawyerChatListPage />} />
            <Route
              path="/lawyer/chat-view/:userId"
              element={<LawyerChatViewPage />}
            />
            <Route
              path="/lawyer/add-bank-details"
              element={<AddBankDetailsPage />}
            />
            <Route
              path="/lawyer/reviews/:lawyerId/:userType"
              element={<ReviewListing />}
            />
            <Route
              path="/lawyer/video-call/:appointmentId"
              element={<LawyerVideoCallPage />}
            />
            <Route
