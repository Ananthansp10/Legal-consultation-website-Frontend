    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 p-6">
      <div className="max-w-7xl mx-auto mt-1">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Manage subscription plans for lawyers
                </p>
              </div>
            </div>
            <button
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          {stats.map((stat, index) => (
            <div
              key={index}
              className="bg-white/10 backdrop-blur-md rounded-2xl p-6 shadow-lg hover:scale-105 transition-all duration-300 hover:shadow-xl border border-white/20"
            >
              <div className="flex items-center justify-between">
                <div>
      ...
      {confirmationModal && (
        <ConfirmModal
          ...
          onConfirm={() =>
            planDelete(planId).then((response) => {
              setPlanId("");
              setRefresh(!refresh);
