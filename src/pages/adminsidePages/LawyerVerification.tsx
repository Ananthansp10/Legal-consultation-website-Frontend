    ...
    <div className="space-y-6">
      <div className="mb-8">
        ...
        <p className="text-slate-600 mt-2">
          Review and verify lawyer registrations with document preview.
        </p>
      </div>
                ...
                >
                  <td className="py-4 px-6">
                    <div className="flex items-center space-x-3">
                      <img
                        src="https://up.yimg.com/ib/th/id/OIP.ncOCV5LVCL8j70Edjgyn6QHaGy?pid=Api&rs=1&c=1&qlt=95&w=133&h=122"
                        alt={lawyer.name[0]}
      ...
      <Modal
        ...
        title={`Details - ${selectedLawyer?.name}`}
        size="xl"
      >
        {selectedLawyer && (
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2 text-sm">
                ...
                <p>
                  <span className="font-medium">Bar License:</span>{" "}
                  {selectedLawyer.barCouncilNumber}
                </p>
                <p>
                  <span className="font-medium">Status:</span> Not Verified
                </p>
              </div>
            </div>
            <div>
