      ...
      <div className="bg-white border-b border-gray-200 sticky top-16 z-40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <div className="relative mb-6">
            ...
            />
            <button
              onClick={searchLawyerByName}
              className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 transition-colors text-sm font-medium"
            >
              Search
            </button>
          </div>
        ...
        <div className="mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-2">
            {activeFilter === "all"
              ? "All Lawyers"
              : `${
                  specializations.find((s) => s.id === activeFilter)?.name
                } Specialists`}
          </h2>
          <p className="text-gray-600">
            {lawyers.length} experienced lawyers available
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {lawyers.map((lawyer) => (
            ...
            >
              ...
              <button
                onClick={() =>
                  navigate(`/user/lawyer-view-page/${lawyer?.lawyerId}`)
                }
