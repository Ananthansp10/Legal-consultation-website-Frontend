            ...
            <div className="glass-card rounded-2xl p-2 bg-white/30 backdrop-blur-md border border-slate-200">
              <div className="grid grid-cols-5 bg-transparent gap-2">
                <button
                  ...
                  className={`flex items-center justify-center px-4 py-2 rounded-xl transition-all duration-200 ${activeTab === "personal" ? "bg-blue-500 text-white" : "text-slate-600 hover:bg-slate-100"
                    }`}
                >
                ...
                <button
                  ...
                  className={`flex items-center justify-center px-4 py-2 rounded-xl transition-all duration-200 ${activeTab === "professional" ? "bg-blue-500 text-white" : "text-slate-600 hover:bg-slate-100"
                    }`}
                >
                ...
                <button
                  ...
                  className={`flex items-center justify-center px-4 py-2 rounded-xl transition-all duration-200 ${activeTab === "documents" ? "bg-blue-500 text-white" : "text-slate-600 hover:bg-slate-100"
                    }`}
                >
                ...
                {!bankDetailsExist && <button
                  ...
                  className={`flex items-center justify-center px-4 py-2 rounded-xl transition-all duration-200 ${activeTab === "wallet" ? "bg-blue-500 text-white" : "text-slate-600 hover:bg-slate-100"
                    }`}
                >
