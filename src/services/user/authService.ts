...
export const signinService = async (data: Signin) => {
  try {
    const result = await axios.post(USER_AUTH_API.SIGNIN, data);
    return result;
  } catch (error) {
    throw error;
  }
...
export const logoutService = async () => {
  try {
    const result = await axios.post(USER_AUTH_API.LOGOUT);
    return result;
  } catch (error) {
    throw error;
  }
...
export const forgotPassword = async (email: string) => {
  try {
    const result = await axios.post(USER_AUTH_API.FORGOT_PASSWORD, { email });
    return result;
  } catch (error) {
    throw error;
  }
...
export const changePaasword = async (data: ChangePasswordData) => {
  try {
    const result = await axios.post(USER_AUTH_API.CHANGE_PASSWORD, data);
    return result;
  } catch (error) {
    throw error;
  }
...
export const resetPassword = async (data: ResetPasswordData) => {
  try {
    const result = await axios.post(USER_AUTH_API.RESET_PASSWORD, data);
    return result;
  } catch (error) {
    throw error;
  }
...
export const getGoogleAuthDetails = async () => {
  try {
    const result = await axios.get(USER_AUTH_API.GOOGLE_AUTH_DETAILS);
    return result;
  } catch (error) {
    throw error;
  }
