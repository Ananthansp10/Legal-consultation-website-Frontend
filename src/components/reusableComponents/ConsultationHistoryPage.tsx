import { Calendar, Video, Phone, User, FileText, MessageSquare } from 'lucide-react';
...
const [consultationHistoryData,setConsultationHistoryData]=useState<ConsultationHistoryData[] | null>(null)
...
useEffect(()=>{
  ...
  const EmptyState = () => (
    <div className="text-center py-12 bg-gray-50 rounded-lg border-2 border-dashed border-gray-300">
      ...
      <p className="text-gray-600 text-lg">No previous consultation found for this case.</p>
      <p className="text-gray-500 text-sm mt-2">Your consultation history will appear here once you start consultations.</p>
    </div>
  );
      ...
      <div className="pt-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            ...
            <p className="text-gray-600">Review your previous consultations and case details</p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-lg border border-gray-200 p-6 mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-3">
                <div>
                  ...
                  <p className="text-gray-900 font-medium">{consultationHistoryData?.[0].userName}</p>
                </div>
                <div>
                  <label className="text-sm font-medium text-gray-500 uppercase tracking-wide">Legal Counsel</label>
                  <p className="text-gray-900 font-medium">{consultationHistoryData?.[0].lawyerName}</p>
                </div>
              </div>
              
              <div className="space-y-3">
                <div>
                  <label className="text-sm font-medium text-gray-500 uppercase tracking-wide">Case ID</label>
            ...
            <div className="mt-4">
              <label className="text-sm font-medium text-gray-500 uppercase tracking-wide">Case Description</label>
              <p className="text-gray-700 mt-1 leading-relaxed">{consultationHistoryData?.[0].caseDescription}</p>
            </div>
          </div>

          {/* Consultation History Section */}
          <div className="mb-4">
            <h2 className="text-2xl font-semibold text-gray-900 mb-6">Consultation History</h2>
          </div>
          ...
          {consultationHistoryData?.length === 0 ? (
            ...
            <div className="space-y-6">
              {consultationHistoryData?.map((consultation) => (
                <div key={consultation.caseId} className="bg-white rounded-lg shadow-md border border-gray-200 hover:shadow-lg transition-shadow duration-200">
                  <div className="p-6">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 pb-4 border-b border-gray-100">
                      <div className="flex items-center mb-2 sm:mb-0">
                        ...
                        <span className="font-semibold text-gray-900">{consultation.history.consultationDate}</span>
                      </div>
                        ...
                        <div className="bg-green-50 p-3 rounded-lg">
                          ...
                          <div className="flex items-center">
                            ...
                            <div className="flex items-center">
                              ...
                              <span className="ml-2 text-sm text-gray-600">({consultation.history.rating}/5)</span>
                            </div>
                          </div>
                        </div>
                      </div>
          ...
          <div className="mt-12 text-center text-gray-500 text-sm">
            <p>Need help with your case? Contact your legal counsel for assistance.</p>
          </div>
        </div>
      </div>
    </div>
