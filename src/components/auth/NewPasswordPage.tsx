        ...
        <div className="absolute inset-0 z-20 flex items-center justify-center">
          <div className="text-center text-white px-8">
            ...
            <p className="text-lg text-white/80 max-w-md">
              Your security is our priority. Set a strong password to protect
              your legal documents and sensitive information.
            </p>
          </div>
        </div>
      </div>
              ...
              {newPassword && (
                <div className="bg-slate-50/50 rounded-xl p-4 space-y-2">
                  ...
                  <div className="space-y-1">
                    <div
                      className={`flex items-center text-sm ${passwordCriteria.hasMinLength ? "text-green-600" : "text-slate-500"}`}
                    >
                    ...
                    <div
                      className={`flex items-center text-sm ${passwordCriteria.hasUppercase ? "text-green-600" : "text-slate-500"}`}
                    >
                    ...
                    <div
                      className={`flex items-center text-sm ${passwordCriteria.hasLowercase ? "text-green-600" : "text-slate-500"}`}
                    >
                    ...
                    <div
                      className={`flex items-center text-sm ${passwordCriteria.hasNumber ? "text-green-600" : "text-slate-500"}`}
                    >
                    ...
                    <div
                      className={`flex items-center text-sm ${passwordCriteria.hasSpecialChar ? "text-green-600" : "text-slate-500"}`}
                    >
