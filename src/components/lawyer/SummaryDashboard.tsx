    ...
    <div className="mb-8">
      ...
      <div className="flex flex-wrap gap-6 mb-8">
        ...
        <div className="bg-white rounded-xl p-6 flex items-center gap-4 shadow-md flex-1">
          ...
          <div>
            <span className="block text-3xl font-bold text-blue-700">
              {summary?.totalConsultations?.[0]?.count}
            </span>
        ...
        <div className="bg-white rounded-xl p-6 flex items-center gap-4 shadow-md flex-1">
          ...
          <div>
            <span className="block text-3xl font-bold text-blue-700">
              {summary?.pendingConsultations?.[0]?.count || 0}
            </span>
        ...
        <div className="bg-white rounded-xl p-6 flex items-center gap-4 shadow-md flex-1">
          ...
          <div>
            <span className="block text-3xl font-bold text-blue-700">
              {summary?.upcomingConsultations?.[0]?.count || 0}
            </span>
            <span className="text-slate-600 text-sm">
        ...
        <div className="bg-white rounded-xl p-6 flex items-center gap-4 shadow-md flex-1">
          ...
          <div>
            <span className="block text-3xl font-bold text-blue-700">
              {summary?.completedConsultations?.[0]?.count || 0}
            </span>
            <span className="text-slate-600 text-sm">
        ...
        <div className="bg-white rounded-xl p-6 flex items-center gap-4 shadow-md flex-1">
          ...
          <div>
            <span className="block text-3xl font-bold text-blue-700">
              {summary?.cancelledConsultations?.[0]?.count || 0}
            </span>
            <span className="text-slate-600 text-sm">
        ...
        <div className="bg-white rounded-xl p-6 flex items-center gap-4 shadow-md flex-1">
          ...
          <div>
            <span className="block text-3xl font-bold text-blue-700">
              {summary?.rejectedConsultations?.[0]?.count || 0}
            </span>
            <span className="text-slate-600 text-sm">
        ...
        <div className="bg-white rounded-xl p-6 flex items-center gap-4 shadow-md flex-1">
          ...
          <div>
            <span className="block text-3xl font-bold text-green-700">
              {summary?.totalRevenue?.[0]?.revenue || 0}
            </span>
